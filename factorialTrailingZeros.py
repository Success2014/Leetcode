# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 20:47:52 2015
...
7!有一个5，10!有两个5。除此之外，还有一件事情要考虑:
诸如25，125之类的数字有不止一个5。
如果我们考虑28!，我们得到一个额外的5，并且0的总数变成了6。
处理这个问题也很简单，首先对n÷5，移除所有的单个5，然后÷25，
